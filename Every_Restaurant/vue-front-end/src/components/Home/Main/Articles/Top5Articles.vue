      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="top-recipe-item large-item">
            <div class="top-recipe-img set-bg" style="background-image: url(/img/top-recipe/recipe-1.jpg)">
              <i class="fa fa-plus"></i>
            </div>
        ...
        <div class="col-lg-6">
          <div class="top-recipe-item">
            <div class="row">
              <div class="col-sm-4">
                <div class="top-recipe-img set-bg" style="background-image: url(/img/top-recipe/recipe-2.jpg)">
                  <i class="fa fa-plus"></i>
                </div>
              </div>
              <div class="col-sm-8">
          ...
          <div class="top-recipe-item">
            <div class="row">
              <div class="col-sm-4">
                <div class="top-recipe-img set-bg" style="background-image: url(/img/top-recipe/recipe-3.jpg)">
                  <i class="fa fa-plus"></i>
                </div>
              </div>
              <div class="col-sm-8">
          ...
          <div class="top-recipe-item">
            <div class="row">
              <div class="col-sm-4">
                <div class="top-recipe-img set-bg" style="background-image: url(/img/top-recipe/recipe-4.jpg)">
                  <i class="fa fa-plus"></i>
                </div>
              </div>
              <div class="col-sm-8">
          ...
          <div class="top-recipe-item">
            <div class="row">
              <div class="col-sm-4">
                <div class="top-recipe-img set-bg" style="background-image: url(/img/top-recipe/recipe-5.jpg)">
                  <i class="fa fa-plus"></i>
                </div>
              </div>
              <div class="col-sm-8">
