...
public class PhoneBookModel implements Collection<Contact> {
     ...
     *
     * @param contact element whose presence in this collection is to be ensured
...
//*-----------------------------------------------------------------------
// Далее идут стандартные методы для работы с коллекцией
